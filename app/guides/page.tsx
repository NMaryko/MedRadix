      ...
      <div className="flex-1 space-y-10">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-sm md:text-base text-[#4b3b2f]">
            <li>
              ...
              ESC жёстко приоритизирует первичное ЧКВ и допускает
              фармакоинвазивный подход при недоступности катетеризации в
              установленные сроки. ACC/AHA детальнее расписывают маршруты
            ...
            <li>
              ...
              В ESC основной акцент на GRACE, в ACC/AHA шире обсуждается
              использование TIMI и HEART для разных ситуаций.
            </li>
            <li>
              ...
              высоким риском кровотечений и подходы к деэскалации.
            </li>
            <li>
              <span className="font-semibold">
              ...
              внимания совместному принятию решений и ступенчатому
              усилению терапии.
            </li>
          </ul>
          <p className="mt-3 text-xs md:text-sm text-[#6b7280]">
            На этапе интеграции Sanity CMS здесь будут добавлены точные ссылки
            на ESC и ACC/AHA с указанием года и версии гайда.
          </p>
        </section>
        ...
        <section id="acs-overview">
          ...
          <p className="text-sm md:text-base text-[#4b3b2f] leading-relaxed">
            ...
            ST (STEMI), инфаркт миокарда без подъёма ST (NSTEMI) и нестабильную
            стенокардию. Ключевое отличие между ними — наличие некроза
            миокарда по тропонину и характер изменений ЭКГ.
          </p>
        </section>
        ...
        <section id="acs-diagnostics">
          ...
          <ul className="list-disc pl-5 space-y-2 text-sm md:text-base text-[#4b3b2f]">
            ...
            <li>
              ...
              при сохраняющейся симптоматике; при подозрении на заднюю /
              правожелудочковую локализацию — дополнительные отведения.
            </li>
            <li>
            ...
            <li>
              ...
              гемодинамика, признаки СН, сопутствующая патология,
              риск кровотечений.
            </li>
          </ul>
        </section>
        ...
        <section id="acs-risk">
          ...
          <p className="mt-2 text-sm md:text-base text-[#4b3b2f]">
            Для STEMI основной выбор — первичное ЧКВ vs тромболизис с
            последующим ЧКВ (фармакоинвазивная стратегия), исходя из времени до
            пункции артерии и логистики.
          </p>
        </section>
        ...
        <section id="acs-reperfusion">
          ...
          <ul className="list-disc pl-5 space-y-2 text-sm md:text-base text-[#4b3b2f]">
            <li>
              ...
              предпочтительно при доступности в рекомендованные сроки;
              тромболизис — альтернатива при невозможности своевременного ЧКВ.
            </li>
            <li>
              <span className="font-semibold">NSTEMI/нестабильная стенокардия:</span>{' '}
              тромболитическая терапия не показана, выбор стратегии определяется
              риском и коронарной анатомией.
            </li>
          </ul>
        </section>
        ...
        <section id="acs-pharm">
          ...
          <ul className="list-disc pl-5 space-y-2 text-sm md:text-base text-[#4b3b2f]">
            <li>
              ...
              подбором препарата по риску ишемии и кровотечений.
            </li>
