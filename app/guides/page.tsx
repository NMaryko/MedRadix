...
// Разделы гайда – используем и для горизонтальных, и для вертикальных табов
const SECTIONS = [
...
// Нозологии кардиологии — по логике будущих гайдов
...
// Группировка нозологий для системного селекта
const GROUPED_CARDIOLOGY_NOSOLOGIES: Record<string, Nosology[]> =
  CARDIOLOGY_NOSOLOGIES.reduce((acc, nosology) => {
    if (!acc[nosology.group]) {
      acc[nosology.group] = [];
    }
    acc[nosology.group].push(nosology);
    return acc;
    ...
    treatment: {
      ...
      adjunctiveTherapy: [
        ...
        },
        {
          ...
          timing:
            'После стабилизации гемодинамики и функции почек',
          contraindications: [
    ...
    <main className="min-h-screen bg-[#fcfcee] py-8">
      <div className="max-w-7xl mx-auto px-4">
              ...
              <div className="flex-1 flex justify-start order-2 lg:order-1 w-full lg:w-auto">
                <div className="flex flex-col gap-1 w-full lg:w-auto">
                  ...
                  <select
                    ...
                    className="rounded-full border border-[#d3cec4] bg-white px-4 py-1.5 text-sm text-[#3b342d] shadow-sm focus:outline-none focus:border-[#015d52] w-full lg:w-[260px]"
                  >
                    {Object.entries(GROUPED_CARDIOLOGY_NOSOLOGIES).map(
                      ([groupName, items]) => (
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          {/* Левое вертикальное меню секций (desktop) */}
          <aside className="hidden lg:block lg:w-64 lg:flex-shrink-0">
            <div className="sticky top-28 bg-white rounded-2xl shadow-lg p-4 space-y-4">
          ...
          <div className="flex-1">
            {/* Горизонтальная навигация для мобильных/планшетов */}
            <div className="flex border-b border-gray-200 mb-8 overflow-x-auto lg:hidden">
              {SECTIONS.map(({ id, label }) => (
                <button
                  key={id}
                  onClick={() => setSelectedTab(id)}
                ...
                <div className="space-y-12">
                  ...
                  <section>
                    ...
                    <p className="mt-2 text-xs text-gray-500">
                      ...
                      отсутствии калькулятора на момент просмотра страница
        ...
        <section className="mt-4 mb-8 text-center">
          ...
          <p className="mt-2 text-xs text-gray-500 max-w-xl mx-auto">
            В следующих версиях MedRadix планируется личный кабинет с
            возможностью формировать папки по нозологиям и специальностям.
            Пока можно использовать закладки браузера.
          </p>
        </section>
        ...
        <section className="border-t border-gray-200 mt-12 pt-8 text-center">
          ...
          <p className="text-lg font_medium text-gray-900">
