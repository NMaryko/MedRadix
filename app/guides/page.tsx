...
const CARDIOLOGY_NOSOLOGIES: string[] = [
  ...
  'ST-элевационный инфаркт миокарда (STEMI)',
  'Не-ST-элевационный острый коронарный синдром (NSTE-ACS)',
  ...
  return (
    <main className="min-h-screen bg-[#fcfcee] py-8">
      <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
                ...
                <div className="space-y-12">
                      ...
                      <div className="flex justify-between items-start mb-4">
                        ...
                        <RecommendationBadge
                          rec={{
                            ...
                            evidenceText:
                              escGuideline.diagnosis.biomarkers.highSensitivityTroponin.evidenceText,
                          }}
                        />
                      </div>
                  ...
                  <section>
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                      ...
                      >
                        <span className="font-semibold text-gray-900 mb-1">GRACE</span>
                        <span className="text-gray-600">
                          Госпитальная и 6-месячная смертность у пациентов с NSTE-ACS.
                        </span>
                      </a>
                      <a
                      ...
                      >
                        <span className="font-semibold text-gray-900 mb-1">HEART</span>
                        <span className="text-gray-600">
                          Быстрая оценка краткосрочного риска МАСЕ в приёмном отделении.
                        </span>
                      </a>
                      <a
                      ...
                      >
                        <span className="font-semibold text-gray-900 mb-1">TIMI для NSTE-ACS</span>
                        <span className="text-gray-600">
                          Стратификация риска осложнений и выбора инвазивной стратегии.
                        </span>
                      </a>
                    </div>
                    <p className="mt-2 text-xs text-gray-500">
                      Переход выполняется в раздел «Калькуляторы». При отсутствии калькулятора на момент
                      просмотра страница может быть недоступна.
                    </p>
                  </section>
                </div>
              )}
              ...
              {selectedTab === 'treatment' && (
                <div className="space-y-12">
                  ...
                  {/* НОВОЕ: Антикоагулянтная терапия */}
                  <section>
                    <h2 className="text-3xl font-bold text-gray-900 mb-6">
                  ...
                  {/* НОВОЕ: Частые ошибки и подводные камни */}
                  <section>
                    <h3 className="text-2xl font-semibold text-gray-900 mb-4">
                      Частые ошибки и подводные камни
                    </h3>
                    <p className="text-sm text-gray-600 mb-4">
                      Блок ориентирован на врачей, работающих в ОИТ, приёмных отделениях и инвазивных
                      лабораториях. Может использоваться как чек-лист перед выпиской пациента.
                    </p>
                      ...
                      {escGuideline.secondaryPrevention.medications.map((med: any, idx: number) => (
                        ...
                        >
                          ...
                          {med.monitoring && (
                            <p className="text-sm text-gray-700 mb-1">
                              Мониторинг:{' '}
                              <span className="font-medium">{med.monitoring}</span>
                            </p>
                          )}
                          {med.deescalation && (
        ...
        {/* НОВОЕ: Кнопка сохранения раздела */}
        <section className="mt-4 mb-8 text-center">
          ...
          <p className="mt-2 text-xs text-gray-500 max-w-xl mx-auto">
            В следующих версиях MedRadix планируется личный кабинет с возможностью формировать папки
            по нозологиям и специальностям. Пока можно использовать закладки браузера.
          </p>
        </section>
        ...
        <section className="border-t border-gray-200 mt-12 pt-8 text-center">
          <p className="text-sm text-gray-600 mb-6 max-w-4xl mx-auto">
            ...
            заменяет профессиональное медицинское заключение. При принятии клинических решений всегда
            следуйте официальным руководствам и локальным протоколам вашего учреждения. Авторы не
            несут ответственности за использование представленной информации в клинической практике.
          </p>
