                ...
                <div className="space-y-10">
                  ...
                  <section className="bg-white rounded-2xl p-6 border border-gray-200">
                    ...
                    <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mt-4">
                      ...
                      <ul className="text-sm text-gray-700 space-y-1 mb-3">
                        <li><Safe text="• TIMI < 3, низкий миокардиальный blush grade, персистирующая ишемия после стентирования" /></li>
                      </ul>
                      <p className="text-sm text-gray-700 mb-2 font-medium">Алгоритм ведения:</p>
                      <ul className="text-sm text-gray-700 space-y-1">
                        <li><Safe text="• Внутрикоронарный аденозин 60–120 мкг болюсно, повторно при необходимости (класс IIa, уровень B)" /></li>
                        <li><Safe text="• Внутрикоронарный нитропруссид 50–200 мкг (IIa/B)" /></li>
                        <li><Safe text="• ГП IIb/IIIa: эптифибатид болюс 180 мкг/кг ×2 с интервалом 10 мин + инфузия 2 мкг/кг/мин 18–24 ч (при высоком тромбозе) (IIa/B)" /></li>
                        <li><Safe text="• Техники: аспирация тромба по показаниям, осторожная постдилатация, оптимизация антикоагуляции (ACT 250–300 с)" /></li>
                      </ul>
                    </div>
                  </section>
                  ...
                  <section className="bg-white rounded-2xl p-6 border border-gray-200">
                    ...
                    <div className="bg-red-50 border border-red-200 rounded-xl p-4 mt-4">
                      <p className="text-sm text-gray-700 mb-2 font-medium">Диагностика:</p>
                      <ul className="text-sm text-gray-700 space-y-1 mb-3">
                        <li><Safe text="• Систолическое АД < 90 мм рт.ст. >30 мин или необходимость вазопрессоров" /></li>
                        <li><Safe text="• Признаки гипоперфузии (олигурия, лактоацидоз, холодные кожные покровы)" /></li>
                      </ul>
                      <p className="text-sm text-gray-700 mb-2 font-medium">Алгоритм:</p>
                      <ul className="text-sm text-gray-700 space-y-1">
                        <li><Safe text="• Немедленное ЧКВ «culprit-only», рассмотреть механическую поддержку кровообращения" /></li>
                        <li><Safe text="• Вазопрессор: норэпинефрин титровать до целевого MAP" /></li>
                        <li><Safe text="• Инотроп: добутамин при сохранённой гипоперфузии (IIa/B)" /></li>
                        <li><Safe text="• Коррекция ацидоза/гипоксии, осторожная инфузионная терапия под эхо-наведением" /></li>
                      </ul>
                    </div>
                  </section>

                  {/* Контраст-индуцированная нефропатия / коморбидности (пример с метформином) */}
                  <section className="bg-white rounded-2xl p-6 border border-gray-200">
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">Сопутствующие состояния, влияющие на терапию</h3>
                    <RecommendationBadge rec={{ class: 'IIa', level: 'B', evidenceText: 'Персонализированная коррекция терапии снижает риск осложнений' }} />
                    <div className="bg-teal-50 border border-teal-200 rounded-xl p-4 mt-4">
                      <ul className="text-sm text-gray-700 space-y-2">
                        <li>
                          <span className="font-medium">СД / Метформин:</span>{' '}
                          <Safe text="временно отменить при планируемом или проведённом контрастировании у пациентов со сниженной СКФ (например, eGFR < 30 мл/мин/1.73м²) и/или при риске CIN; возобновить после оценки функции почек через 48–72 ч." />
                          <div className="mt-1">
                            <RecommendationBadge rec={{ class: 'IIa', level: 'B', evidenceText: 'Безопасность при контрасте; локальные протоколы' }} />
                          </div>
                        </li>
                        <li>
                          <span className="font-medium">ХБП:</span>{' '}
                          <Safe text="коррекция доз антикоагулянтов (эноксапарин 1 мг/кг 1 раз/сут при КК < 30), избегать нефротоксинов, мониторинг калия при МРА." />
                        </li>
                        <li>
                          <span className="font-medium">Высокий риск кровотечений:</span>{' '}
                          <Safe text="деэскалация ДАТТ до 3–6 мес; рассмотреть переход на клопидогрел после 1–3 мес (PRECISE-DAPT, ARC-HBR)." />
                        </li>
                      </ul>
                    </div>
                  </section>
