// app/guides/acs/page.tsx — КОД-ОКС (финал)
'use client';
...
export default function ACSPage() {
  ...
  const handleSaveSection = () => {
    // Подключим логику позже (сейчас — активная кнопка без алертов)
  };
      ...
      <div className="max-w-[1800px] mx-auto px-4">
        ...
        <section className="border-b border-gray-200 mb-8">
          <div className="max-w-[1800px] mx-auto px-4 pt-4 pb-4">
            <div className="flex flex-col lg:flex-row items-center gap-4 lg:gap-0">
              {/* Специальность — ПЕРВАЯ на мобильных */}
              <div className="flex-1 flex justify-start order-2 lg:order-3 w-full lg:w-auto">
                <div className="flex flex-col gap-1 w-full lg:w-auto">
                  ...
                  <select
                    ...
                    className="rounded-full border border-[#d3cec4] bg-white px-4 py-2 text-sm text-[#3b342d] shadow-sm focus:outline-none focus:border-[#015d52] w-full lg:w-[230px]"
                  >
              ...
              <div className="flex-shrink-0 text-center order-1 lg:order-2">
                ...
                <p className="text-lg text-gray-600">Клиническое руководство {escGuideline.version}</p>
              </div>

              {/* Нозология — ВТОРАЯ на мобильных */}
              <div className="flex-1 flex justify-end order-3 lg:order-1 w-full lg:w-auto">
                <div className="flex flex-col gap-1 w-full lg:w-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
                ...
                {sections.map(({ id, label }) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full rounded-full border px-3.5 py-2.5 text-[14px] text-left font-medium transition
                        ${
                          active
                            ? 'bg-[#013c37] text-white border-[#013c37]'
                            : 'bg-white text-[#1f2933] border-[#d3cec4]'
                        }
                        hover:ring-2 hover:ring-[#015d52] hover:shadow-[0_0_0_3px_rgba(1,93,82,0.15)]`}
                    >
                      {label}
                    </button>
                  );
          ...
          <div className="flex-1 min-w-0">
            {/* Навигация чипами – мобильные/планшеты: расширенные тач-таргеты */}
            <div className="flex lg:hidden border-b border-gray-200 mb-6 overflow-x-auto">
              {sections.map(({ id, label }) => (
                <button
                  key={id}
                  onClick={() => setSelectedTab(id)}
                  className={`px-5 py-3 min-h-[44px] border-b-2 font-medium text-[15px] whitespace-nowrap ${
                    selectedTab === id
                      ? 'border-[#015d52] text-[#015d52]'
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 mb-8">
              ...
              {selectedTab === 'diagnosis' && (
                <div className="space-y-12">
                  {/* Краткая ориентация (сворачиваемая) */}
                  <section>
                    <button
                      onClick={() => setBriefOpen((v) => !v)}
                      className="w-full flex items-center justify-between rounded-xl border border-[#d3cec4] bg-[#f8f8f3] px-4 py-3 text-left"
                    >
                      <span className="font-semibold text-gray-900">Краткая ориентация (ОКС)</span>
                      <ChevronDown
                    ...
                    {briefOpen && (
                      <div className="mt-3 rounded-xl border border-[#e6e1d8] p-4 text-sm text-gray-800">
                        <ul className="list-disc pl-5 space-y-1">
                          <li>STEMI: немедленное ЧКВ ≤120 мин (или фибринолиз при задержке).</li>
                          <li>NSTE-ACS: стратификация по GRACE; ранняя инвазивная тактика при высоком риске.</li>
                          <li>Тропонин по протоколу 0/1 или 0/2 часа, динамика ≥20%.</li>
                          <li>ДАТТ 12 мес. с выбором P2Y12; статины высокой интенсивности всем.</li>
                          <li>Целевой ЛПНП &lt;1.4 ммоль/л; реабилитация и контроль факторов риска.</li>
                        </ul>
                      </div>
                    )}
                  </section>
                      ...
                      <div className="bg-red-50 rounded-xl p-6 border border-red-200">
                        ...
                        {escGuideline.diagnosis.ecgCriteria.stemi.map((criteria, idx) => (
                          <div key={idx} className="mb-6 last:mb-0">
                            <div className="flex flex-col md:flex-row md:flex-wrap md:items-start md:justify-between gap-3 mb-3">
                  ...
                  <section>
                    ...
                    <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-4">
                      ...
                      >
                        ...
                        <span className="text-gray-600">Госпитальная и 6-месячная смертность у пациентов с NSTE-ACS.</span>
                      </a>
                      <a
                      ...
                      >
                        ...
                        <span className="text-gray-600">Быстрая оценка краткосрочного риска МАСЕ в приёмном отделении.</span>
                      </a>
                      <a
                      ...
                      >
                        ...
                        <span className="text-gray-600">Стратификация риска осложнений и выбора инвазивной стратегии.</span>
                      </a>
                    </div>
                  </section>
                </div>
                    ...
                    <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
                      {escGuideline.treatment.anticoagulation.map((ac: any, idx: number) => (
                        <div key={idx} className="bg-white rounded-xl p-6 border border-gray-200">
                          <div className="flex flex-col md:flex-row md:flex-wrap md:items-start md:justify-between gap-4 mb-3">
                    ...
                    <div className="space-y-4">
                      {escGuideline.secondaryPrevention.medications.map((med: any, idx: number) => (
                        <div key={idx} className="bg-white rounded-lg p-4 border border-blue-100">
                          <div className="flex flex-col md:flex-row md:flex-wrap md:items-start md:justify-between gap-4 mb-2">
        ...
        <section className="mt-4 mb-8 text-center">
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#015d52] bg-white text-sm font-medium text-[#015d52] hover:ring-2 hover:ring-[#015d52] hover:shadow-[0_0_0_3px_rgba(1,93,82,0.15)] transition"
          >
            <FolderPlus size={16} />
