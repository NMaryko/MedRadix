...
const SECTIONS: SectionConfig[] = [
  ...
  },
  {
    ...
    title: 'Папки',
    description:
      'Папки — ваша личная библиотека MedRadix. Формируйте собственную коллекцию избранных гайдов, разделов и препаратов, а также сохраняйте сертификаты и файлы в личном кабинете с автоматическим подсчётом баллов (CME/НМО).',
    href: '/folders',
  },
];
